/**
*\file combat.cpp
*\brief module qui gere la phase de combat
*/
 ...
 *
 * \param Ju: premier personnage
 * \param Tancou: second personnage
 * \param e: evenementDispo
 * \param posJu: position du premier personnage
 * \param posTancou: position du second personnage
 *
 */
...
/** \brief accesseur du premier personnage
 *
 * \return le premier personnage
 *
 */
...
/** \brief accesseur du second personnage
 *
 * \return le second personnage
 *
 */
...
/** \brief accesseur de l'évenement en cours
 *
 * \return l'évenement en cours
 *
 */
...
/** \brief accesseur de la disponibilité d'un évenement
 *
 * \return vrai pour pouvoir initialiser un nouvel évenement, faux sinon
 *
 */
...
/** \brief accesseur de la position du premier personnage
 *
 * \return la position du premier personnage
 *
 */
...
/** \brief accesseur de la position du second personnage
 *
 * \return la position du second personnage
 *
 */
...
/** \brief mutateur du premier personnage
 *
 * \param Ju: le nouveau personnage
 *
 */
...
/** \brief mutateur du second personnage
 *
 * \param Tancou: le nouveau personnage
 *
 */
...
/** \brief mutateur de l'évenement en cours
 *
...
/** \brief mutateur de la disponibilité de l'évenement
 *
 * \param e: vrai pour disponible, faux sinon
 *
 */
...
/** \brief mutateur de la position du premier personnage
 *
 * \param ptJ : la nouvelle position du personnage
 *
 */
...
/** \brief mutateur de la position du second personnage
 *
 * \param ptT : la nouvelle position du personnage
 *
 */
...
/** \brief fonction affichage du combat (barres de vies, personnages)
 */
...
/** \brief fonction d'affichage des barres de vies
 */
...
/** \brief fonction d'affichage du premier personnage
 */
...
/** \brief fonction d'affichage du second personnage
 */
...
/** \brief fonction qui génere et calcule le combat
 */
	...
	while (!quit) {
        ...
        if  (SDL_PollEvent(&events))
		{
			...
			{              // Si une touche est enfoncee
				...
				//Touches J
				/*if(state[SDL_SCANCODE_A] && J.getetat().getAttaque() == 0)
				{
                        J.vaGauche(decor);
				}

				if(state[SDL_SCANCODE_D] && J.getetat().getAttaque() == 0)
				{
                        J.vaDroite(decor);
				}*/
...
/** \brief fonction qui gère les adjuvents (évenements spontanés)
 */
void Combat::Adjuvants(int & tMama, int & tAttal, int & tDejou, int & tFelix, int & tRomain, int &RomainX, int &RomainY, bool& objDejaPris)
{
    ...
    if (tMama == 0 && tDejou != 0)
    {
        ...
        else if (tDejou < SDL_GetTicks() - 9500)
        {
            ...
            eventDispo = false;
            objDejaPris = false;
            J.setvitesse_att(300.0);
            T.setvitesse_att(300.0);
            J.setvitesse_depl(6.0);
            T.setvitesse_depl(6.0);
        }
    }
...
/** \brief fonction debug qui réinitialise les hibox des personnages a celles de départ.
 */
...
/** \brief fonction qui calcule si deux rectangles se touchent
 *
 * \param a : le premier rectangle
 * \param b : le second rectangle
 * \return vrai si les deux rectangles se touchent sur au moins un point, faux sinon
 *
 */
